      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 px-8">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none transition bg-white"
                onFocus={(e) => (e.target.style.boxShadow = `0 0 0 3px ${C.secondary}30`)}
                onBlur={(e) => (e.target.style.boxShadow = "none")}
              >
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl text-white font-semibold text-sm shadow-lg hover:opacity-90 active:scale-95 transition-all"
